...
def main(mode, experiment_path, inference_file):
    ...
    parser.add_argument('--body_model', type=str, default='skipnet', choices=['resnet18', 'resnet50'],
    ...
    parser.add_argument('--batch_size', type=int, default=2)  # use batch size = double(categorical emotion classes)
    # SAM
